...
<style>
    ...
    .rounded-btn:hover {
        background-color: rgb(205, 199, 182);
        color: rgb(98, 82, 37);
        text-decoration: none;
...
<div class="hiltons-btn">
    <a class="rounded-btn" target="_blank" rel="noopener noreferrer"
       href="https://www.hilton.com/en/hotels/skdsrhi-hilton-samarkand-regency/">
        Hilton Samarkand Regency
    </a>

    <a class="rounded-btn" target="_blank" rel="noopener noreferrer"
       href="https://www.hilton.com/en/hotels/skdsagi-hilton-garden-inn-samarkand-afrosiyob/">
        Hilton Garden Inn Samarkand Afrosiyob
    </a>

    <a class="rounded-btn" target="_blank" rel="noopener noreferrer"
       href="https://www.hilton.com/en/hotels/skdssgi-hilton-garden-inn-samarkand-sogd/">
