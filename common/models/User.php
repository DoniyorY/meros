...
class User extends ActiveRecord implements IdentityInterface
{
   ...
   public function rules()
   {
      return [
         ...
         [['username', 'email', 'password', 'fullname', 'phone'], 'required'],
         [['username', 'email', 'password', 'fullname', 'phone', 'address'], 'string'],
   ...
   {
      return $this->hasMany(Billing::class, ['user_id' => 'id'])->orderBy(['id'=>SORT_DESC]);
   }
}
