...
$messages = [
    'ru' => [
        'preheader' => 'Подтвердите ваш email, чтобы завершить регистрацию в Meros International Institute.',
        'badge' => 'Подтверждение email',
        'title' => 'Добро пожаловать в Meros International Institute!',
        'hello' => 'Здравствуйте, {name}!',
        'intro' => 'Спасибо за регистрацию. Остался последний шаг — подтвердите ваш email, чтобы получить доступ к личному кабинету и материалам курса.',
    ...
    'uz' => [
        'preheader' => 'Meros International Institute ro‘yxatdan o‘tishini yakunlash uchun emailingizni tasdiqlang.',
        'badge' => 'Emailni tasdiqlash',
    ...
    'en' => [
        'preheader' => 'Confirm your email to complete your Meros International Institute registration.',
        'badge' => 'Email verification',
        'title' => 'Welcome to Meros International Institute!',
        'hello' => 'Hello, {name}!',
        'intro' => 'Thank you for registering. There is just one step left: confirm your email to access your account and course materials.',
        'button' => 'Verify email',
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 16px 40px rgba(15,23,42,.10);">
                ...
                <tr>
                    <td align="center" style="padding:26px 32px;">
                        <a href="<?= Html::encode($verifyLink) ?>" style="display:inline-block;background:#0f78a8;color:#ffffff;text-decoration:none;border-radius:14px;padding:16px 30px;font-size:16px;font-weight:800;box-shadow:0 10px 22px rgba(15,120,168,.28);">
                ...
                <tr>
                    <td style="padding:0 32px 28px;">
                        <div style="padding:18px;border-radius:16px;background:#f8fafc;border:1px solid #e2e8f0;">
                            ...
                            <a href="<?= Html::encode($verifyLink) ?>" style="font-size:13px;line-height:1.6;color:#0f78a8;word-break:break-all;text-decoration:underline;">
